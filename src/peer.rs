...
impl<'a> Peer<'a> {
    ...
    pub fn connect(
        ...
        tasks.push(tokio::spawn(async move {
            ...
            h1[48..68].copy_from_slice(b"hellomynameisgamer12"); // FIX THIS LATER
            ...
            stream.read_exact(&mut bitfield).await.unwrap();
            ...
            loop {
                ...
                tokio::select! {
                    result = stream.read_exact(&mut length_bytes) => {
                        result.unwrap();
                        stream.read_exact(&mut message_id).await.unwrap();
                    }
                ...
                if !choked && current_piece_index == usize::MAX {
                    ...
                    while begin_offset < this_piece_length {
                        ...
                        payload[0..4].copy_from_slice(&(current_piece_index as u32).to_be_bytes());
